...
class Teletrain extends ex_classlite
{
    ...
    public function getinfo($params)
    {
        ...
        if ($this->Auth->userauth()) {
            if ($params[1] == "v3") {
                ...
                $Parser->SetUseParser("Teletrain", md5($text), $this->Auth->getuserid());
    ...
    private function v2($content)
    {
        ...
        foreach ($blank as $value) {
            ...
            $serviceblank["Profit"] = $this->DTV($json, ["UfsProfit"]) / count($blank);
...
//            $service["LongitudeDeparture"] = $DepartureGeoData["longitude"];
            ...
            $service["supplier"] = ["INN" => "7706556924", "KPP" => "770601001", "Name" => "Телетрейн"];
