...
class CorteoscbLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Corteoscb")) {

            $Model = loader("Corteoscb", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found Corteoscb parser"];
        }
