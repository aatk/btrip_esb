...
class TeletrainLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Teletrain")) {

            $Model = loader("Teletrain", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found Teletrain parser"];
        }
