...
class AviacenterLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Aviacenter")) {

            $Model = loader("Aviacenter", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found Amadeus parser"];
        }
