...
class GalileoLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Galileo")) {

            $Galileo = loader("Galileo", $this->metod, $this->debugclass);
            $Galileo->POST = $this->POST;
            $Galileo->phpinput = $this->phpinput;
            $Params[1] = "v3";
            $result = $Galileo->getinfo($Params);
            ...
            $result["errors"] = ["not found Galileo parser"];
        }
