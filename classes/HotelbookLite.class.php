...
class HotelbookLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Hotelbook")) {

            $Model = loader("Hotelbook", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found Hotelbook parser"];
        }
