...
class HotelBedsLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("HotelBeds")) {

            $Model = loader("HotelBeds", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found HotelBeds parser"];
        }
