...
class PortbiletLite extends ex_class
{
    private $metod;
    private $Auth;
    ...
    public function getinfo($Params)
    {
        ...
        $result = ["result" => false];
        if (class_exists("Portbilet")) {

            $Model = loader("Portbilet", $this->metod, $this->debugclass);
            ...
            $result["errors"] = ["not found Portbilet parser"];
        }
